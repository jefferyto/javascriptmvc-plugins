...
steal.plugins('jquery/controller/subscribe', 
  ...
  },
  {
    ...
    getPrefix: function() {
      ...
      if (!TR.StateMachine.Controller.statePrefixCounter[controllerName]) {
        TR.StateMachine.Controller.statePrefixCounter[controllerName] = 0;
      }
    
      return controllerName + ".instance" + TR.StateMachine.Controller.statePrefixCounter[controllerName]++;
    }
  }
  );
